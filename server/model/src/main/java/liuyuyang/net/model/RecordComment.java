...
public class RecordComment extends BaseModel {
    ...
    @ApiModelProperty(value = "说说ID", example = "1", required = true)
    @NotNull(message = "说说ID不能为空", groups = {ValidationGroups.Create.class, ValidationGroups.Update.class})
